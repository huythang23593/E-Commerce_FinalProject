            ...
            <div class="row">
                <div class="col-xl-9 col-lg-8 col-md-7">
                    ...
                    <section class="lattest-product-area pb-40 category-list">
                            ...
                            <c:forEach var="p" items="${productDetail}">
                                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 single-product">
                                    ...
                                    <div class="content">
                                        ...
                                        <img  src = "<c:url value="/resources/img/${p.products.image.name}"/>" style="border:1px solid black" >
                                        <div class="content-details fadeIn-bottom">
                                            <div class="bottom d-flex align-items-center justify-content-center">
                                                <a href="#"><span class="lnr lnr-heart"></span></a>
                                                <a href="${contextPath}/product-detail/${p.id}"><span class="lnr lnr-layers"></span></a>
                                                <a href="${contextPath}/addorder/${p.id}/0"><span class="lnr lnr-cart"></span></a>
                        ...
                        <c:if test="${productDetail == null || fn:length(productDetail) <= 0}">
                        ...
                        <c:if test="${productDetail != null || fn:length(productDetail) > 0}">
                            <div class="pagination">
                                ...
                                <c:forEach var="c" begin="1" end="${count}">
                                    <c:choose>
                                        <c:when test="${c==1}">
                                            <a href="${contextPath}/productDetail/${c-1}" class="active">${c}</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="/productDetail/${c-1}" class="active">${c}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                ...
                <div class="col-xl-3 col-lg-4 col-md-5">
                    <div class="sidebar-categories">
                        ...
                        <div class="head">Price</div>    
                                    ...
                                    <li class="main-nav-list child"><a href="${contextPath}/search-price/${51}/${100}">51$ To 100$<span class="number"></span></a></li>
                                    <li class="main-nav-list child"><a href="${contextPath}/search-price/${101}/${150}">101$ To 150$<span class="number"></span></a></li>

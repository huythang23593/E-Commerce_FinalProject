                    ...
                    <div class="col-lg-6">
                        <div class="quick-view-content">
                            <div class="top">
                                ...
                                <div class="price d-flex align-items-center"><span class="lnr lnr-tag"></span> <span class="ml-10">${detail.price}$</span></div>
                            ...
                            <form action="<c:url value="/updateProductDetailId" />" method="POST" >
                                <div class="row">
<!--                                    <div class="category"><span>&nbsp;&nbsp; Mã Sản Phẩm: &nbsp;&nbsp;</span> </div>-->
<input type="number" name="detailId" readonly="true" value="${detail.id}" hidden="" />
